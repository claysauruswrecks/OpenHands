...
VSCODE_REMOTE_CONTROL_PORT_RANGE = (60000, 64999)
...
class DockerRuntime(ActionExecutionClient):
    ...
    def __init__(
        ...
        self._vscode_port = -1
        self._vscode_remote_control_port = -1
    ...
    def init_container(self) -> None:
        ...
        self._vscode_remote_control_port = self._find_available_port(
            VSCODE_REMOTE_CONTROL_PORT_RANGE
        )
        self._app_ports = [
        ...
        if not use_host_network:
            ...
            if self.vscode_enabled:
                ...
                # Also expose port for vscode-remote-control extension
                port_mapping[f'{self._vscode_remote_control_port}/tcp'] = [
                    {
                        'HostPort': str(self._vscode_remote_control_port),
                        'HostIp': self.config.sandbox.runtime_binding_address,
                    }
                ]
        ...
        environment.update(
            {
                ...
                'VSCODE_REMOTE_CONTROL_PORT': str(self._vscode_remote_control_port),
    ...
    def _attach_to_container(self) -> None:
        ...
        for env_var in config['Env']:
            ...
            elif env_var.startswith('VSCODE_REMOTE_CONTROL_PORT='):
                self._vscode_remote_control_port = int(
                    env_var.split('VSCODE_REMOTE_CONTROL_PORT=')[1]
                )
        ...
        if exposed_ports:
            for exposed_port in exposed_ports.keys():
                ...
                if (
                    ...
                    and exposed_port != self._vscode_remote_control_port
                ):
    ...
    @property
    def vscode_remote_control_port(self) -> int:
        """Get the port for the vscode-remote-control extension."""
        return self._vscode_remote_control_port
    ...
    def get_action_execution_server_startup_command(self) -> list[str]:
        return get_action_execution_server_startup_command(
            ...
            override_username='root',  # Run as root like KubernetesRuntime for simplicity
        )
