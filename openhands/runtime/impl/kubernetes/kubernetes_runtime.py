...
class KubernetesRuntime(ActionExecutionClient):
    ...
    def __init__(
        ...
        self._vscode_remote_control_port = 8082  # Default VSCode remote control port
    ...
    def _get_runtime_pod_manifest(self):
        ...
        environment = [
            ...
            V1EnvVar(
                name="VSCODE_REMOTE_CONTROL_PORT",
                value=str(self._vscode_remote_control_port),
            ),
        ]
        ...
        if self.vscode_enabled:
            ...
            container_ports.append(
                V1ContainerPort(
                    container_port=self._vscode_remote_control_port,
